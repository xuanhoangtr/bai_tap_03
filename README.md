...
![Email nhận mã OTP kích hoạt tài khoản](images/email_kich_hoat.png)

![Màn hình xác thực OTP kích hoạt tài khoản](images/xac_thuc_otp.png)

![Kích hoạt tài khoản thành công](images/kich_hoat_thanh_cong.png)

---

### 2. Quên mật khẩu gửi xác nhận OTP qua mail

![Giao diện yêu cầu gửi OTP quên mật khẩu](images/quen_mat_khau.png)

![Email nhận mã OTP đặt lại mật khẩu](images/email_quen_mat_khau.png)

![Màn hình đặt lại mật khẩu mới](images/dat_lai_mat_khau.png)

![Đặt lại mật khẩu thành công](images/doi_pass_thanh_cong.png)

---

### 3. Hiển thị 10 sản phẩm mới nhất lên trang chủ

![Trang chủ hiển thị 10 sản phẩm mới nhất](images/trang_chu.png)

---

### 4. Hiển thị tất cả sản phẩm được phân trang 6sp/trang hiển thị trên trang có URL là /product

![Tất cả sản phẩm phân trang 6 sản phẩm trên 1 trang](images/phan_trang_sp.png)

---

### 5. Quản lý danh mục (Category)

![Danh sách Category](images/quan_tri_category.png)

---

### 6. CRUD cho bảng Products và upload file bằng Multipart

![Danh sách sản phẩm](images/quan_tri_sp.png)

![Thêm sản phẩm mới và upload ảnh bằng Multipart](images/them_sp_multipart.png)
